/* Executive Engagements: the four-question finder and the request it produces. Loads after site.js on /catalogue/organizational only. Logic unchanged from gateway.js; moved whole per the Phase 1 plan of record. */
...
const reqformEl=$('#reqform');
if(reqformEl) reqformEl.addEventListener('submit',async e=>{
  e.preventDefault();
  const ref=makeRef();
